...
- 生成的灵犀 Skill 文件保存在用户本地的 `companions/` 目录，已被 `.gitignore` 排除，不会被提交到 Git 仓库
...
- 提取自己参与的聊天记录，用于情感陪伴与个人回忆
- 基于自己的记忆描述生成 AI 人格，仅供个人使用
- 为朋友、亲人、恋人等创建情感陪伴 Skill
...
本项目的初衷是帮助用户完成情感记忆的数字化存档和情感陪伴，而非替代真实的人际关系。如果你在使用过程中发现自己：
