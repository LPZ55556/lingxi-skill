...
```bash
cd .claude/skills/create-lingxi  # 或你的安装路径
...
2. 手动选择并复制关键对话
3. 粘贴到一个 txt 文件中
4. 在 `/create-lingxi` 时使用方式 D（上传文件）
...
### Q: 可以同时创建多个灵犀 Skill 吗？
A: 可以。每个灵犀会生成独立的 `companions/{slug}/` 目录。

### Q: 创建后还能修改吗？
A: 可以。说"ta不会这样说"触发对话纠正，或"我有新文件"追加原材料。每次修改都有版本存档，可以回滚。

### Q: 支持哪些关系类型？
A: 朋友、恋人、家人、同事、师长、任何你在乎的人。

### Q: 灵犀会越聊越像吗？
A: 是的。通过 LoRA 持续学习（对话纠正）和长期记忆积累，灵犀会越来越了解你和 ta。
